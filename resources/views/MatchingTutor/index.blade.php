...
<body id="">
    ...
    <form action="{{ route('tutorform.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="main" id="section1">
            <section class="page-section d-flex justify-content-center align-items-center" id="topic">
                <div class="container">
                    ...
                    <a href="#section2" class="btn btn-danger">ต่อไป</a>
                </div>
            </section>
        </div>
        ...
        <div class="main" id="section2">
            <section class="page-section d-flex justify-content-center align-items-center" id="targetSection">
                <div class="container">
                        ...
                        <div class="box">
                            <div class="item">
                                <div class="checkbox-rect2">
                                    <input type="text" name="tutor_id" value="{{ auth()->guard('tutor')->user()->id }}" hidden>
                    ...
                    <a href="#section3" class="btn btn-danger">ต่อไป</a>
                </div>
            </section>
        </div>
        ...
        <div class="main" id="section3">
            <section class="page-section d-flex justify-content-center align-items-center" id="location">
                <div class="container">
                    ...
                    <a href="#section4" class="btn btn-danger mt-2">ต่อไป</a>
                </div>
            </section>
        </div>
                ...
                <div class="container">
                    ...
                    <div class="grid-container">
                        <div class="box">
                            ...
                            {{-- <div class="item">
                                <div class="checkbox-rect2">
                                    <input class="form-check-input" type="checkbox" id="checkbox-mo7" name="check">
                                    <label for="checkbox-mo7">รวมเนื้อหามอต้น</label>
                                </div>
                            </div>
                            <div class="item">
                                <div class="checkbox-rect2">
                                    <input class="form-check-input" type="checkbox" id="checkbox-mo8" name="check">
                                    <label for="checkbox-mo8">รวมเนื้อหามอปลาย</label>
                                </div>
                            </div> --}}
                        </div>
                    </div>
                    <a href="#section5" class="btn btn-danger">ต่อไป</a>
                </div>
            </section>
        </div>
                            ...
                            <div class="item">
                                <div class="checkbox-rect2">
                                    <input class="form-check-input" type="checkbox" id="checkbox-mm1"
                                        value="เรียนแบตัวต่อตัว" name="stlye[]">
                                    <label for="checkbox-mm1">เรียนแบตัวต่อตัว</label>
                                </div>
                            </div>
                            <div class="item">
                                <div class="checkbox-rect2">
                                    <input class="form-check-input" type="checkbox" id="checkbox-mm2"
                                        value="เรียนแบบเป็นกลุ่ม" name="stlye[]">
                                    <label for="checkbox-mm2">เรียนแบบเป็นกลุ่ม</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="#section6" class="btn btn-danger">ต่อไป</a>
                </div>
            </section>
        </div>
