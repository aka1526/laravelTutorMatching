                ...
                <div class="col-md-3">
                    <div class="container" id="fitering">
                        <div class="sidebar mt-4">
                            ...
                            <form action="{{ route('tutorTutorsList') }}" method="GET">
                                <div class="mt-4">
                                    <h5><b>เพศ</b></h5>
                                    <div>
                                        <label for="male">
                                            <input type="checkbox" id="genderCB" name="gender[]" value="ชาย">ชาย
                                        </label>
                                    </div>
                                    <div>
                                        <label for="female">
                                            <input type="checkbox" id="genderCB" name="gender[]" value="หญิง">หญิง
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <a a href="{{ route('tutorDetails', $tutor->id) }}"
