            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="container" id="fitering">
                        <div class="sidebar mt-4">
                            ...
                            <form action="{{ route('tutorsList') }}" method="post">
                                @csrf
                                <div class="mt-4">
                                    <h5><b>เพศ</b></h5>
                                    <div>
                                        <label for="male">
                                            <input type="checkbox" id="genderCB" name="gender[]" value="ผู้ชาย">  ผู้ชาย
                                        </label>
                                    </div>
                                    <div>
                                        <label for="female">
                                            <input type="checkbox" id="genderCB" name="gender[]" value="ผู้หญิง">  ผู้หญิง
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="container mt-4">
                        <form action="{{ route('tutorsList') }}" method="GET">
                            <div class="row">
                                <div class="col-11">
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <a a href="{{ route('nouserTutorDetails', $tutor->id) }}"
                                            class="btn btn-danger mt-auto mx-auto"><i class="fa fa-eye"></i> ดูรายละเอียด</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
