                            ...
                            <div class="col-md-12">
                                <div class="card-body mx-md-10">
                                    <div class="text-center">
                                        ...
                                        <h2 class="mt-2">Tutor Matching</h2>
                                        <label style="font-size: 20px">สำหรับติวเตอร์</label>
                                    </div>
                                    

                                    <form method="POST" action="{{ route('tutor.handleLogin') }}">
                                        @csrf
                                            ...
                                            @if (Route::has('tutor.registerPage'))
                                                <button type="button" class="btn btn-danger">
                                                    <a class="link-light" id="test"
                                                        href="{{ route('tutor.registerPage') }}">สมัครเป็นติวเตอร์</a>
                                                </button>
                                            @endif
                                        </div>
                                    </form>
